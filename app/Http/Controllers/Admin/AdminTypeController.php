...
class AdminTypeController extends Controller
{
     public function index()
    {
        ...
        return view("admin.userType.adminUserType")->with($response_data);
    }
    ...
    public function create(Request $request)
    {
        ...
        $validator = Validator::make($new_request,
            [
                'name'          => 'required|min:'.limit("user_type.min").'|max:'.limit("user_type.max").'|string|not_exists:admin_user_types,name,deleted_at,NULL',
            ]);
